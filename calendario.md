...
<table class="rwd-table" id="table-wrap">
    ...
    <tbody>
        ...
        <tr style="background-color: #f2f2f2;">
            <td data-th="DÍAS">30 de septiembre de 2024.</td>
        ...
        <tr style="background-color: #f2f2f2;">
            ...
            <td data-th="HORA">Av. Arcos núm. 767, Colonia Jardines del Bosque, CP 44520, Guadalajara, Jalisco.9:30 am </td>  
        </tr>
        ...
        <tr>
            ...
            <td data-th="HORA">Av. Arcos núm. 767, Colonia Jardines del Bosque, CP 44520, Guadalajara, Jalisco.9:00 am</td>
                ...
                <tr>
            <td data-th="DÍAS">Del 7 al 11 de octubre de 2024.</td>
            <td data-th="ACTIVIDAD">Sesión de la Comisión para realizar evaluación curricular y determinar los 10 mejores perfiles</td>
            <td data-th="LUGAR">Sesión virtual y presencial</td>
        ...
        <tr style="background-color: #f2f2f2;">
            <td data-th="DÍAS">21 y 22 de octubre de 2024.</td>
...
<table class="rwd-table" id="table-wrap">
    ...
    <tbody>
        <tr>
            ...
            <td data-th="ACTIVIDAD">Rueda de prensa de emisiòn de la Convocatoria</td>
            <td data-th="LUGAR">Colegio de Jalisco, Auditorio Alfonso De Alba, Calle 5 de mayo, número 321, Colonia Loma Blanca, C.P. 45100, Zapopan, Jalisco.</td>
            <td data-th="HORA">10:00 horas</td>
        </tr>
        
            <tr style="background-color: #f2f2f2;">
            <td data-th="DÍA" >Lunes 02 de octubre al  viernes 13 de octubre de 2023.</td>
            <td data-th="ACTIVIDAD">Recepción de candidaturas (fisicas)</td>
            <td data-th="LUGAR"> En físico y USB.Av. Arcos número 767, Col. Jardines del Bosque vía electrónica al correo:
            <a href="mailto:candidatos@comisionsaejalisco.org">candidatos@comisionsaejalisco.org</a></td>
            <td data-th="HORA">De lunes a viernes de las 9:00 a 15:00 horas Último día, hasta las 17:00 horas</td>
        </tr>
        ...
        <tr style="background-color: #f2f2f2;">
            <td data-th="DÍAS">Martes 17 de octubre de 2023.</td>
            <td data-th="ACTIVIDAD">Sesión de la Comisión para determinar qué aspirantes cumplen con la documentación requerida y los requisitos que establece la Ley y la Convocatoria. </td>
            <td data-th="LUGAR">Sesión virtual y presencial</td>
            <td data-th="HORA">Av. Arcos núm. 767, Colonia Jardines del Bosque, CP 44520, Guadalajara, Jalisco.9:00 am </td>  
        </tr>
        ...
        <tr>
            <td data-th="DÍAS">Jueves 19 de octubre de 2023.</td>
        ...
        <tr style="background-color: #f2f2f2;">
            <td data-th="DÍAS">Viernes 20  y sábado 21 de octubre de 2023.</td>
            <td data-th="ACTIVIDAD">Realización de las entrevistas/comparecencias, públicas (invitados de sociedad civil, académicos y especialistas en la materia)</td>
            <td data-th="LUGAR">Universidad Panamericana Álvaro del Portillo No. 49,Ciudad Granja CP 45010 Zapopan, Jalisco, México</td>
            <td data-th="HORA">Viernes 20 de octubre 4:00 pm. Sábado 21 de octubre 9:00 am</td>
        </tr>
        
        <tr style="background-color: #f2f2f2;">
            <td data-th="DÍAS">Sábado 21 de octubre de 2023.</td>
            <td data-th="ACTIVIDAD">Sesión de la Comisión para elegir al nuevo integrante del Comité de Participación Social del Sistema Anticorrupción del Estado de Jalisco para el período 2023-2028</td>
            <td data-th="LUGAR">Sesión virtual y presencial</td>
            <td data-th="HORA">Al termino de las comparecencias</td>
        </tr>
            ...
            <tr style="background-color: #f2f2f2;">
            <td data-th="DÍAS">Por definir</td>
            <td data-th="ACTIVIDAD">Toma de protesta al integrante del Comité de Participación Social del Sistema Anticorrupción del Estado de Jalisco para el período 2023-2028</td>
            <td data-th="LUGAR">Universidad Panamericana Álvaro del Portillo No. 49, Ciudad Granja CP 45010 Zapopan, Jalisco, México</td>
            <td data-th="HORA">11:00 am</td>
        </tr>
    </tbody>
</table>
<p></p>
...
<table class="rwd-table" id="table-wrap">
    ...
    <tbody>
        ...
        <tr style="background-color: #f2f2f2;">
            ...
            <td data-th="ACTIVIDAD">Recepción de candidaturas</td>
            <td data-th="LUGAR"> José Guadalupe Zuno Hernández, número 2118. Col. Obrera o vía electrónica al correo:
                <a href="mailto:candidatos@comisionsaejalisco.org">candidatos@comisionsaejalisco.org</a></td>
            <td data-th="HORA"> </td>
        ...
        <tr>
            <td data-th="DÍA"> Martes 2 de octubre del 2018 a las 15:00 horas.</td>
            <td data-th="ACTIVIDAD"> Cierre de recepción de candidaturas.</td>
            <td data-th="LUGAR"> José Guadalupe Zuno Hernández, número 2118. Col. Obrera o vía electrónica al correo:
                <a href="mailto:candidatos@comisionsaejalisco.org">candidatos@comisionsaejalisco.org</a></td>
            <td data-th="HORA"> </td>
        ...
        <tr>
            <td data-th="DÍAS">Miércoles 3 de octubre de 2018</td>
        ...
        <tr>
            <td data-th="DÍAS">Martes 9 de octubre de 2018</td>
            <td data-th="ACTIVIDAD">Sesión de la Comisión para la designación de expedientes por revisar de acuerdo con los grupos conformados y el total de candidatos.</td>
            <td data-th="LUGAR">El Colegio de Jalisco</td>
            <td data-th="HORA">A partir de las 10:00 a 15:00 horas</td>
           
        </tr>
        <tr>
            <td data-th="DÍAS">Miércoles 17 de octubre de 2018.</td>
            <td data-th="ACTIVIDAD">Sesión de la Comisión para la evaluación documental y curricular para identificar a los 10 mejores perfiles.</td>
            <td data-th="LUGAR">El Colegio de Jalisco</td>
            <td data-th="HORA"></td>
          
        </tr>
        <tr>
            <td data-th="DÍAS">Viernes 19 de octubre de 2018.</td>
            <td data-th="ACTIVIDAD">Publicación de los nombres de las 10 personas seleccionadas y del calendario de entrevistas individuales con los candidatos. </td>
            <td data-th="LUGAR">http://comisionsaejalisco.org/</td>
            <td data-th="HORA"></td>
           
        </tr>
        <tr>
            <td data-th="DÍAS">Lunes 22 de octubre de 2018.</td>
            <td data-th="ACTIVIDAD">Realización de las entrevistas/comparecencias, públicas (invitados de sociedad civil, académicos y especialistas en la materia).</td>
            <td data-th="LUGAR">Por definir</td>
            <td data-th="HORA"></td>
...
<p></p>
<p></p>
<h4 style="text-align:center;">Calendario 2017</h4>
<br><br>
<table class="rwd-table" id="table-wrap">
  <thead><tr>
    <th>DÍA(S)</th>
  ...
  <tr>
    ...
    <td data-th="LUGAR"> Calle José Guadalupe Zuno no. 2118, Col. Obrera, Guadalajara, Jal.</td>
    <td data-th="HORA"> 14:30 horas</td>
    <td data-th="OBJETIVO"> Atestiguar el cierre del registro de aspirantes a la Convocatoria</td>
  </tr>
  <tr><td data-th="ACTIVIDAD" colspan="4" style="background-color: #ffffff;"> Publicación de la Metodología de evaluación documental y curricular</td></tr>
  <tr style="background-color: #f2f2f2;">
    <td data-th="DÍA" rowspan="2"> 16 de octubre 2017</td>
    <td data-th="ACTIVIDAD"> Sesión de la Comisión de Selección</td>
    <td data-th="LUGAR"> Rectoría General de la Universidad de Guadalajara, planta baja. Avenida Juárez 976, Col. Americana, 44100 Guadalajara, Jal.</td>
    <td data-th="HORA"> 16:00 horas</td>
    <td data-th="OBJETIVO"> Entrega de expedientes para la evaluación curricular</td>
  </tr>
  <tr style="background-color: #f2f2f2;"><td data-th="ACTIVIDAD" colspan="4" style="background-color: #f2f2f2;"> Acuerdo para la publicación de la lista de aspirantes así como de los siguientes documentos de cada uno de ellos: (1) Curriculum vitae; (2) Exposición de motivos; (3) Carta bajo protesta de decir verdad</td></tr>
  <tr>
    <td data-th="DÍA"> 19 de octubre 2017</td>
    <td data-th="ACTIVIDAD"> Sesión de la Comisión de Selección</td>
    <td data-th="LUGAR"> El Colegio de Jalisco</td>
    <td data-th="HORA"> 13:00 horas</td>
    <td data-th="OBJETIVO"> Deliberación con base en los resultados de la metodología de evaluación documental y curricular</td>
  </tr>
  <tr style="background-color: #f2f2f2;">
  ...
  <tr>
    ...
    <td data-th="OBJETIVO"> Deliberación de la Comisión de Selección para la designación de los integrantes del Comité de Participación Social del Sistema Anticorrupción del Estado de Jalisco</td>
  </tr>
  <tr>
    <td data-th="DÍA"> 1 de noviembre 2017</td>
    <td data-th="ACTIVIDAD"> Entrega de nombramientos</td>
    <td data-th="LUGAR Y HORA" colspan="2"> PENDIENTE</td>
